...
def formattingStatusOrders(file):
    ...
    for riga in ws.iter_rows(min_row=2, max_row=ws.max_row, min_col=7, max_col=7):
        for cella in riga:
...
if __name__ == "__main__":
    file_path = "Status_OrdersMerged.xlsx"  # Specifica il percorso del file
